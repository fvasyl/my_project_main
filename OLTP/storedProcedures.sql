...
IF OBJECT_ID ( 'location.UpsertCountry', 'P' ) IS NOT NULL   ---ADD or Change Country
...
IF OBJECT_ID ( 'location.UpsertCity', 'P' ) IS NOT NULL   ---ADD or Change City
...
IF OBJECT_ID ( 'location.UpsertSportArena', 'P' ) IS NOT NULL   ---ADD or Change SportArena
