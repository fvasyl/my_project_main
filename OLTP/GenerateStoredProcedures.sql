...
IF OBJECT_ID ( 'dbo.AddSomeMatch', 'P' ) IS NOT NULL   ---ADD or Change Match
...
IF OBJECT_ID ( 'dbo.AddSomeResult', 'P' ) IS NOT NULL   ---ADD or Change Result 
...
IF OBJECT_ID ( 'dbo.AddSomeStake', 'P' ) IS NOT NULL   ---ADD or Change Stake 
